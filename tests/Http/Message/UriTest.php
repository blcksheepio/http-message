...
class UriTest extends TestCase
{
    ...
    public function testWithSchemeReturnsSameInstanceIfWithSchemeIsIdentical()
    {
     ...
     */
    public function testWithUserInfoReturnsNewInstanceWithNewUser($user, $password)
    {
        $uri = new Uri('https://user:pass@local.example.com:3001/foo?bar=baz#quz');
    ...
    public function testWithUserInfoReturnsSameInstanceIfUserAndPasswordAreIdentical()
    {
        $uri = new Uri('https://user:pass@local.example.com:3001/foo?bar=baz#quz');
     ...
     * @dataProvider invalidPHPDataTypesForSchemeDataProvider
     */
    public function testWithUserInfoThrowsExceptionIfUserIsInvalidDataType($user)
    {
        self::expectException(InvalidArgumentException::class);
     ...
     * @dataProvider invalidPHPDataTypesForSchemeDataProvider
     */
    public function testWithUserInfoThrowsExceptionIfPasswordIsInvalidDataType($password)
    {
        self::expectException(InvalidArgumentException::class);
